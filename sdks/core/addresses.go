...
var DefaultNetworks = []ChainId{Mainnet, Goerli, Sepolia}

func ConstructSameAddressMap(address string, additionalNetworks ...ChainId) AddressMap {
	allChains := append(DefaultNetworks, additionalNetworks...)

	m := make(AddressMap, len(allChains))
...
var UNIAddresses = ConstructSameAddressMap(
...
const UniswapNFTAirdropClaimAddress = "0x8B799381ac40b838BBA4131ffB26197C432AFe78"

var V2FactoryAddresses = AddressMap{
	...
	ArbitrumOne:     "0xf1D7CC64Fb4452F05c498126312eBE29f30Fbcf9",
	...
	UniChainSepolia: "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f",
	UniChain:        "0x1f98400000000000000000000000000000000002",
	MonadTestnet:    "0x733e88f248b742db6c14c0b1713af5ad7fdd59d0",
	Soneium:         "0x97febbc2adbd5644ba22736e962564b23f5828ce",
	Monad:           "0x182a927119d56008d921126764bf884221b10f59",
	XLayer:          "0xdf38f24fe153761634be942f9d859f3dba857e95",
	Linea:           "0x114A43DF6C5f54EBB8A9d70Cd1951D3dD68004c7",
}

var V2RouterAddresses = AddressMap{
	Mainnet:         "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D",
	Goerli:          "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D",
	Sepolia:         "0xeE567Fe1712Faf6149d80dA1E6934E354124CfE3",
	ArbitrumOne:     "0x4752ba5dbc23f44d87826276bf6fd6b1c372ad24",
	...
	UniChainSepolia: "0x920b806E40A00E02E7D2b94fFc89860fDaEd3640",
	UniChain:        "0x284f11109359a7e1306c3e447ef14d38400063ff",
	MonadTestnet:    "0xfb8e1c3b833f9e67a71c859a132cf783b645e436",
	Soneium:         "0x273f68c234fa55b550b40e563c4a488e0d334320",
	Monad:           "0x4b2ab38dbf28d31d467aa8993f6c2585981d6804",
	XLayer:          "0x182a927119d56008d921126764bf884221b10f59",
	Linea:           "0x8702463e73f74d0b6765abceb314ef07acb92650",
}

var DefaultAddresses = ChainAddresses{
...
var MainnetAddresses = ChainAddresses{
	...
	NonfungiblePositionManagerAddress: DefaultAddresses.NonfungiblePositionManagerAddress,
...
var GoerliAddresses = ChainAddresses{
	V3CoreFactoryAddress:              DefaultAddresses.V3CoreFactoryAddress,
	MulticallAddress:                  DefaultAddresses.MulticallAddress,
	QuoterAddress:                     DefaultAddresses.QuoterAddress,
	V3MigratorAddress:                 DefaultAddresses.V3MigratorAddress,
...
var OptimismAddresses = ChainAddresses{
	V3CoreFactoryAddress:              DefaultAddresses.V3CoreFactoryAddress,
	MulticallAddress:                  DefaultAddresses.MulticallAddress,
	QuoterAddress:                     DefaultAddresses.QuoterAddress,
	V3MigratorAddress:                 DefaultAddresses.V3MigratorAddress,
...
var ArbitrumOneAddresses = ChainAddresses{
	V3CoreFactoryAddress:              DefaultAddresses.V3CoreFactoryAddress,
	QuoterAddress:                     DefaultAddresses.QuoterAddress,
	V3MigratorAddress:                 DefaultAddresses.V3MigratorAddress,
	NonfungiblePositionManagerAddress: DefaultAddresses.NonfungiblePositionManagerAddress,
...
var PolygonAddresses = ChainAddresses{
	V3CoreFactoryAddress:              DefaultAddresses.V3CoreFactoryAddress,
	MulticallAddress:                  DefaultAddresses.MulticallAddress,
	QuoterAddress:                     DefaultAddresses.QuoterAddress,
	V3MigratorAddress:                 DefaultAddresses.V3MigratorAddress,
...
var CeloAddresses = ChainAddresses{
...
var BnbAddresses = ChainAddresses{
...
var OptimismGoerliAddresses = ChainAddresses{
...
var OptimismSepoliaAddresses = ChainAddresses{
...
var ArbitrumGoerliAddresses = ChainAddresses{
...
var ArbitrumSepoliaAddresses = ChainAddresses{
...
var SepoliaAddresses = ChainAddresses{
...
var AvalancheAddresses = ChainAddresses{
...
var BaseAddresses = ChainAddresses{
...
var BaseGoerliAddresses = ChainAddresses{
...
var BaseSepoliaAddresses = ChainAddresses{
...
var ZoraAddresses = ChainAddresses{
...
var ZoraSepoliaAddresses = ChainAddresses{
...
var RootstockAddresses = ChainAddresses{
...
var BlastAddresses = ChainAddresses{
...
var ZkSyncAddresses = ChainAddresses{
...
var WorldChainAddresses = ChainAddresses{
...
var UnichainSepoliaAddresses = ChainAddresses{
	V3CoreFactoryAddress:              "0x1F98431c8aD98523631AE4a59f267346ea31F984",
...
var UnichainAddresses = ChainAddresses{
...
var MonadTestnetAddresses = ChainAddresses{
...
var MonadAddresses = ChainAddresses{
...
var SoneiumAddresses = ChainAddresses{
...
var XLayerAddresses = ChainAddresses{
...
var LineaAddresses = ChainAddresses{
...
var ChainToAddressesMap = map[ChainId]ChainAddresses{
	Mainnet:         MainnetAddresses,
	Optimism:        OptimismAddresses,
	ArbitrumOne:     ArbitrumOneAddresses,
	Polygon:         PolygonAddresses,
	PolygonMumbai:   PolygonAddresses,
	Goerli:          GoerliAddresses,
	Celo:            CeloAddresses,
	CeloAlfajores:   CeloAddresses,
	Bnb:             BnbAddresses,
	OptimismGoerli:  OptimismGoerliAddresses,
	OptimismSepolia: OptimismSepoliaAddresses,
	ArbitrumGoerli:  ArbitrumGoerliAddresses,
	ArbitrumSepolia: ArbitrumSepoliaAddresses,
	Sepolia:         SepoliaAddresses,
	Avalanche:       AvalancheAddresses,
	Base:            BaseAddresses,
	BaseGoerli:      BaseGoerliAddresses,
	BaseSepolia:     BaseSepoliaAddresses,
	Zora:            ZoraAddresses,
	ZoraSepolia:     ZoraSepoliaAddresses,
	Rootstock:       RootstockAddresses,
	Blast:           BlastAddresses,
	Zksync:          ZkSyncAddresses,
	Worldchain:      WorldChainAddresses,
	UniChainSepolia: UnichainSepoliaAddresses,
	UniChain:        UnichainAddresses,
	MonadTestnet:    MonadTestnetAddresses,
	Soneium:         SoneiumAddresses,
	Monad:           MonadAddresses,
	XLayer:          XLayerAddresses,
	Linea:           LineaAddresses,
}

var V3CoreFactoryAddresses = func() AddressMap {
	m := make(AddressMap)
	for _, chainId := range SupportedChains {
		m[chainId] = ChainToAddressesMap[chainId].V3CoreFactoryAddress
	}
	return m
}()

var V3MigratorAddresses = func() AddressMap {
	m := make(AddressMap)
	for _, chainId := range SupportedChains {
		v3MigratorAddress := ChainToAddressesMap[chainId].V3MigratorAddress
		if v3MigratorAddress != "" {
			m[chainId] = v3MigratorAddress
		}
	}
	return m
}()

var MulticallAddresses = func() AddressMap {
	m := make(AddressMap)
	for _, chainId := range SupportedChains {
		m[chainId] = ChainToAddressesMap[chainId].MulticallAddress
	}
	return m
}()

var GovernanceAlphaV0Addresses = ConstructSameAddressMap("0x5e4be8Bc9637f0EAA1A755019e06A68ce081D58F")

var GovernanceAlphaV1Addresses = AddressMap{
	Mainnet: "0xC4e172459f1E7939D522503B81AFAaC1014CE6F6",
}

var GovernanceBravoAddresses = AddressMap{
	Mainnet: "0x408ED6354d4973f66138C91495F2f2FCbd8724C3",
}

var TimeLockAddresses = ConstructSameAddressMap("0x1a9C8182C09F50C8318d769245beA52c32BE35BC")

var MerkleDistributorAddress = AddressMap{
	Mainnet: "0x090D4613473dEE047c3f2706764f49E0821D256e",
}

var ArgentWalletDetectorAddress = AddressMap{
	Mainnet: "0xeca4B0bDBf7c55E9b7925919d03CbF8Dc82537E8",
}

var QuoterAddresses = func() AddressMap {
	m := make(AddressMap)
	for _, chainId := range SupportedChains {
		m[chainId] = ChainToAddressesMap[chainId].QuoterAddress
	}
	return m
}()

var NonfungiblePositionManagerAddresses = func() AddressMap {
	m := make(AddressMap)
	for _, chainId := range SupportedChains {
		nonfungiblePositionManagerAddress := ChainToAddressesMap[chainId].NonfungiblePositionManagerAddress
		if nonfungiblePositionManagerAddress != "" {
			m[chainId] = nonfungiblePositionManagerAddress
		}
	}
	return m
}()

var ENSRegistrarAddresses = ConstructSameAddressMap("0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e")

var SocksControllerAddresses = AddressMap{
	Mainnet: "0x65770b5283117639760beA3F867b69b3697a91dd",
}

var TickLensAddresses = func() AddressMap {
	m := make(AddressMap)
	for _, chainId := range SupportedChains {
		tickLensAddress := ChainToAddressesMap[chainId].TickLensAddress
		if tickLensAddress != "" {
			m[chainId] = tickLensAddress
		}
	}
	return m
}()

var MixedRouteQuoterV1Addresses = func() AddressMap {
	m := make(AddressMap)
	for _, chainId := range SupportedChains {
		mixedRouteQuoterV1Address := ChainToAddressesMap[chainId].MixedRouteQuoterV1Address
		if mixedRouteQuoterV1Address != "" {
			m[chainId] = mixedRouteQuoterV1Address
		}
	}
	return m
}()

var SwapRouter02Address = func() AddressMap {
	m := make(AddressMap)
	for _, chainId := range SupportedChains {
		swapRouter02Address := ChainToAddressesMap[chainId].SwapRouter02Address
		if swapRouter02Address != "" {
			m[chainId] = swapRouter02Address
		} else {
			m[chainId] = "0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45"
		}
	}
	return m
}()
